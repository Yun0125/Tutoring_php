...
<head>
	...
	<script>
		function processDelete(num) {
			...
			if(result) {
				location.href="delete_hotel.php?num="+num;
			}
		}
	</script>
    <style>
...
<body>
        <div class="container">
            ...
            <div class="form-group">
                ...
                <textarea rows="5" id="content" class="form-control" ><?=$msg["Content"] ?></textarea>
            </div>
            <button type="button" onclick="location.href='modify_hotelform.php?num=<?= $msg["Num"] ?>'" class="btn btn-primary btn-lg">수정하기</button>
            <button type="submit" onclick="delete_hotel.php"class="btn btn-primary btn-lg">삭제하기</button>
            <button type="button" onclick="location.href='hotelreview.php'" class="btn btn-primary btn-lg">목록보기</button>
        </div>
</body>
</html>